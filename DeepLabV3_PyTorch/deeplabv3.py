...
class AsppModule(nn.Module):
    def __init__(self, out_channels=40, bn_momentum=0.1, output_stride=16, pooling_size=None):
...
def main():
    ...
    net = DeepLabV3(output_stride=16, class_num=num_classes, pretrained=False)
    out = net(x)
    print(out.shape)
